...
ScheduleGrid = function(viewer, config) {
    ...
    this.store = new Ext.data.GroupingStore({
        url: 'res/php/schedule-load.php?new_table=true',
        reader: this.reader,
        groupField:'date'
        //fields: ['id', 'name', 'passengers', 'driver', 'sent', 'phone', 'cost', 'address_apt', 'address_num', 'address_street', 'destination', {name: 'timestamp', type: 'date', dateFormat: 'Y-m-d H:i:s'}]
    });
	...
	this.filters = new Ext.grid.GridFilters({
	  filters:[
	    ...
	    {type: 'string',  dataIndex: 'address_apt'},
	    {type: 'string',  dataIndex: 'address_num'},
	    {type: 'string',  dataIndex: 'address_street'},
...
//        },
    ...
    this.on('afterEdit', function (row) {
        ...
        Ext.Ajax.request({
            url: 'res/php/trip-edit.php?new_table=true',
            params: {
